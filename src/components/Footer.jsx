...
export default function Footer() {
    ...
    return (
        <footer className={`w-full mt-auto border-t transition-all duration-300 ${
            isDarkMode 
                ...
                <div className="py-8 md:py-12">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                        ...
                        <div className="col-span-1 md:col-span-2">
                            ...
                            <p className={`text-sm leading-relaxed max-w-md ${
                                ...
                                Connect with friends and family through our modern, secure, and intuitive chat platform. 
                                Experience seamless communication with real-time messaging and beautiful design.
                            </p>
                    ...
                    <div className={`mt-8 pt-8 border-t flex flex-col sm:flex-row justify-between items-center ${
                        ...
                        <div className={`text-sm mt-2 sm:mt-0 ${
                            ...
                            Made with ❤️ by <span className="font-semibold bg-gradient-to-r from-pink-600 to-purple-600 bg-clip-text text-transparent">Nitindeep Singh</span>
                        </div>
                    </div>
                </div>
            </div>
